<?php
 ...
 function getActions($row,$showUrl)
{
    ...
    $actionBtn = ' <button class="btn btn-primary btn-icon btn-sm" onclick="location.href=\'' . url()->current() . '/' . $row->id . '/edit' . '\'" data-id="' . $row->id . '" id="edit">
      ...
      $actionBtn .= '<button class="btn btn-secondary btn-icon btn-sm ml-2" onclick="location.href=\'' . $showUrl  . '\'" data-id="' . $row->id . '" id="edit"  style="
      margin-left: 7px;
  ">
